...
alert("Alright. So we're both going to draw numbers from 0 to 10.") 
alert("I will always stop drawing numbers once I reach 16, but you can go draw as many numbers as you want. But remember, try to stay under 20!")
...
do {
    ...
    do {
        ...
        do {
            ...
            alert(`Your next number is ${nextNum}. Your total is now ${myTotal}. `)
            var nextNumQ = prompt(`Would you like to pick another number?`)
        } while (nextNumQ != "no") 
...
if (((((win == "no") &&  (lose == "no") &&  (tie == "no") &&  (cScoreOver == "no") &&  (myScoreOver == "no"))))) {
